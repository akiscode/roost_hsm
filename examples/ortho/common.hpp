...
#ifndef ROOST_ORTHO_COMMON_HPP
#define ROOST_ORTHO_COMMON_HPP
...
static const char* EvtStrings[] = {"NONE", "E1", "E2", "E3", "E4", "E5"};
...
// for other key part
extern template class roost::NodeAlias<ortho::Ctx, ortho::Evt>;
